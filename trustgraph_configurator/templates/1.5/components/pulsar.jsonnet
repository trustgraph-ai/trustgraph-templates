...
local oxia = import "stores/oxia.jsonnet";
...

{
    ...
    "pulsar" +: {
        ...
        create:: function(engine)
            ...
            local initContainer =
                engine.container("pulsar-init")
                    ...
                    .with_command([
                        "bash",
                        "-c",
                        "sleep 10 && bin/pulsar initialize-cluster-metadata --cluster cluster-a --metadata-store oxia://oxia:6648 --configuration-metadata-store oxia://oxia:6648 --web-service-url http://pulsar:8080 --broker-service-url pulsar://pulsar:6650",
                    ])
                    .with_limits("1", "512M")
            ...
            local bookieContainer = 
                engine.container("bookie")
                    ...
                    .with_environment({
                        ...
                        "bookieId": "bookie",
                        "metadataServiceUri": "oxia://oxia:6648/ledgers",
            ...
            // Pulsar broker, stateless (uses oxia and Bookkeeper for state)
            local brokerContainer = 
                engine.container("pulsar")
                    ...
                    .with_environment({
                        "metadataStoreUrl": "oxia://oxia:6648",
                        "configurationMetadataStoreUrl": "oxia://oxia:6648",
                        "bookkeeperMetadataServiceUri": "oxia://oxia:6648/ledgers",
                        "clusterName": "cluster-a",
